  ...
  <div className="about-content">
    ...
    <div className="side-text">
      ...
      <p>
        ...
        research.
        <br /> Educational website can include websites that have games, videos
        or topic related resources that act as tools to enhance learning and
        supplement classroom teaching. These websites help make the process of
        ...
        JavaScript, we can make learning more easier and in a interesting way.
      </p>
    </div>
  </div>
</div>
